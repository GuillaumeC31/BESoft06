                ...
                <div class="card-body p-4">\
                    <div class="row align-items-center team-row">\
                            ...
                            <div class="row">\
                                ...
                                <div class="col text-end dropdown">\
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">\
                                        <li><a class="dropdown-item edit-list" href="#addmemberModal"  data-bs-toggle="modal" data-edit-id="'+teamData.id+'"><i class="ri-pencil-line me-2 align-bottom text-muted"></i>Modifier</a></li>\
                                        <li><a class="dropdown-item remove-list" href="#removeMemberModal" data-bs-toggle="modal" data-remove-id="'+teamData.id+'"><i class="ri-delete-bin-5-line me-2 align-bottom text-muted"></i>Effacer</a></li>\
                                    </ul>\
                                </div>\
                            </div>\
                        </div>\
                            ...
                            <div class="team-profile-img">\
                                ...
                                <div class="team-content">\
                                    <a class="member-name" data-bs-toggle="offcanvas" href="#member-overview" aria-controls="member-overview">\
                                        <h5 class="fs-16 mb-1">'+teamData.memberName+' '+teamData.memberLastName+'</h5>\
                                    </a>\
                        ...
                        <div class="col-lg-4 col">\
                            <div class="row text-muted text-center">\
                                <div class="col-6 border-end border-end-dashed">\
                                    <h5 class="mb-1 society-num">'+teamData.society+'</h5>\
                                    <p class="text-muted mb-0">Société</p>\
                                </div>\
                                <div class="col-6">\
                                    <h6 class="mb-1 service-num">'+teamData.service+'</h6>\
                        ...
                        <div class="col-lg-2 col">\
                            <div class="text-end">\
                                <a href="pages-profile" class="btn btn-light view-btn">Voir le profil</a>\
                            </div>\
                        </div>\
                    </div>\
                </div>\
        ...
        elem.addEventListener('click', function (event) {
            ...
            allmemberlist = allmemberlist.map(function (item) {
                if (item.id == getEditid) {
                    ...
                    if(item.memberImg == ""){
                        document.getElementById("member-img").src = "{{ asset('assets/images/users/user-dummy-img.jpg') }}";
                    }else{
                    ...
                    document.getElementById('teammembersLastName').value = item.memberLastName;
                    document.getElementById('designation').value = item.position;
                    document.getElementById('society-input').value = item.society;
                    document.getElementById('service-input').value = item.service;
...
Array.from(document.querySelectorAll(".addMembers-modal")).forEach(function (elem) {
    elem.addEventListener('click', function (event) {
      document.getElementById("createMemberLabel").innerHTML = "Ajouter de nouveaux membres";
      document.getElementById("addNewMember").innerHTML = "Ajouter des membres";
      document.getElementById("teammembersName").value = "";
      document.getElementById("designation").value = "";

      document.getElementById("cover-img").src = "{{ asset('assets/images/small/img-9.jpg') }}";
      document.getElementById("member-img").src = "{{ asset('assets/images/users/user-dummy-img.jpg') }}";
        ...
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    if(memberImgValue == "{{ asset('assets/images/users/user-dummy-img.jpg') }}"){
                        memberImageValue = ""
                    }else{
                        ...
                        allmemberlist = allmemberlist.map(function (item) {
                            if (item.id == getEditid) {
                                var editObj = {
                                    ...
                                    'memberLastName': inputLastName,
                                    'position': inputDesignation,
                                    'society': document.getElementById('society-input').value,
...
function memberDetailShow() {
    Array.from(document.querySelectorAll(".team-box")).forEach(function (item) {
        item.querySelector(".member-name").addEventListener("click", function () {
            ...
            var memberLastName = item.querySelector(".member-lastname h5").innerHTML;
            ...
            var membersociety = item.querySelector(".society-num").innerHTML;
            var memberservice = item.querySelector(".service-num").innerHTML;
            ...
            document.querySelector("#member-overview .profile-lastname").innerHTML = memberLastName;
            document.querySelector("#member-overview .profile-designation").innerHTML = memberDesignation;

            document.querySelector("#member-overview .profile-society").innerHTML = membersociety;
            document.querySelector("#member-overview .profile-service").innerHTML = memberservice;
        });
    }); 
}
